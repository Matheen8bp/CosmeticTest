          ...
          <CardContent>
            <Tabs defaultValue="owner" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6">
                <TabsTrigger value="owner" className="data-[state=active]:bg-cyan-500 data-[state=active]:text-white">
                  Owner
                </TabsTrigger>
                <TabsTrigger value="dealer" className="data-[state=active]:bg-cyan-500 data-[state=active]:text-white">
                  Dealer
                </TabsTrigger>
              </TabsList>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="focus:border-cyan-500 focus:ring-cyan-500 pr-10"
                    />
                    <Button
                      type="button"
                      variant="ghost"
